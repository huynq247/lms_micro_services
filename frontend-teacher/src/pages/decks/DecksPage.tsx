    ...
    <GlassBackground>
            ...
            <Box display="flex" alignItems="center">
              ...
              <Box>
                <Typography variant="h6" sx={{ 
                  fontWeight: 'bold',
                  color: '#1e3c72',
                  textShadow: '0 1px 2px rgba(30, 60, 114, 0.3)',
                  fontSize: '1.5rem'
                }}>
                ...
                <Typography variant="body2" sx={{ 
                  color: '#1e3c72',
                  opacity: 0.8,
                  textShadow: '0 1px 2px rgba(30, 60, 114, 0.2)'
                }}>
                  Total Decks
                </Typography>
              </Box>
      ...
      {(!decksData?.decks || decksData.decks.length === 0) ? (
        <GlassPaper>
          ...
          <Typography variant="body1" paragraph sx={{ mb: 3, color: '#1e3c72' }}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 0.5 }}>
                              <Typography 
                                ...
                                sx={{ 
                                  ...
                                  mr: 1,
                                  color: '#1e3c72',
                                  textShadow: '0 2px 4px rgba(30, 60, 114, 0.3)',
                                  transition: 'all 0.3s ease'
                                }}
                              >
                                {deck.title}
                              ...
                              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                {deck.instructor_name && (
                                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    <Person sx={{ fontSize: 14, mr: 0.5, color: '#1e3c72' }} />
                                    <Typography variant="caption" sx={{ color: '#1e3c72' }}>
