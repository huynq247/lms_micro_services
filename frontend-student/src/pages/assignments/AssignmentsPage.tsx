    ...
    return (
      <GlassBackground>
        <Box sx={{ maxWidth: 1200, mx: 'auto', p: 4, textAlign: 'center' }}>
          <Typography color="white" variant="h6">Loading assignments...</Typography>
        </Box>
      </GlassBackground>
    );
  }
    ...
    <GlassBackground>
      <Box sx={{ maxWidth: 1200, mx: 'auto', p: 4 }}>
        ...
        <Box sx={{ mb: 4, textAlign: 'center' }}>
          <Typography variant="h3" color="white" gutterBottom sx={{ 
            fontWeight: 800,
            background: 'linear-gradient(45deg, #87CEEB, #4682B4, #1e3c72)',
          ...
          <Typography variant="subtitle1" color="#E3F2FD" sx={{ 
            mb: 2,
                  ...
                  <Box sx={{ display: 'grid', gap: 3 }}>
                    {getFilteredAssignments(index).length === 0 ? (
                      <Box sx={{ textAlign: 'center', py: 6 }}>
                        <Assignment sx={{ fontSize: 80, color: 'rgba(135, 206, 235, 0.8)', mb: 2 }} />
                          ...
                          <Card 
                            sx={{
                              ...
                              '&:hover': {
                                ...
                                transform: 'translateY(-4px)',
                                boxShadow: '0 12px 40px rgba(135, 206, 235, 0.15)',
