    ...
    return (
      <GlassBackground>
        <Box sx={{ maxWidth: 1200, mx: 'auto', p: 4, textAlign: 'center' }}>
          <Typography variant="h6" sx={{ color: 'rgba(255,255,255,0.95)' }}>Loading assignment...</Typography>
        </Box>
      </GlassBackground>
    );
  }
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 3 }}>
          <Box sx={{ flex: 1 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              ...
              <Typography variant="h4" component="h1" sx={{ ml: 2, color: 'rgba(255,255,255,0.95)' }}>
                {assignment.title}
              </Typography>
              {isInstructor && (
                <IconButton sx={{ ml: 2 }}>
