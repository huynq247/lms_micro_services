  ...
  return (
    <GlassBackground>
              ...
              >
                ...
                >
                  <CardContent sx={{ 
                    ...
                    {!session?.showAnswer && (
                      <Typography variant="body2" color="rgba(255,255,255,0.6)" sx={{ fontStyle: 'italic' }}>
                        Click to flip
                      </Typography>
                    )}
                  </CardContent>
      ...
      <Dialog 
        ...
        PaperProps={{
          sx: {
            background: 'linear-gradient(135deg, rgba(25, 118, 210, 0.9) 0%, rgba(26, 35, 126, 0.9) 100%)',
            backdropFilter: 'blur(10px)',
            border: '1px solid rgba(255,255,255,0.2)',
          }
        }}
      >
        <DialogTitle sx={{ textAlign: 'center', color: 'white' }}>
          ...
          <Typography variant="h5">Study Session Complete!</Typography>
        </DialogTitle>
        <DialogContent>
          <Box sx={{ textAlign: 'center', color: 'white' }}>
            ...
            <Box sx={{ mt: 3, display: 'flex', justifyContent: 'space-around' }}>
              <Paper sx={{ p: 2, bgcolor: 'rgba(255,255,255,0.1)', minWidth: 80 }}>
                <Typography variant="h6" color="#4caf50">
