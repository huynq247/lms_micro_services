...
const DeckDetailPage: React.FC = () => {
    ...
    return (
      <GlassBackground>
        <Box sx={{ maxWidth: 1200, mx: 'auto', p: 4, textAlign: 'center' }}>
          <Typography variant="h6" sx={{ color: 'rgba(255,255,255,0.95)' }}>Loading Deck...</Typography>
        </Box>
      </GlassBackground>
    );
  }
  ...
  if (!deck) {
    return (
      <GlassBackground>
        <Box sx={{ maxWidth: 1200, mx: 'auto', p: 4, textAlign: 'center' }}>
          <Typography variant="h6" gutterBottom sx={{ color: 'rgba(255,255,255,0.95)' }}>Deck Not Found</Typography>
          <Button startIcon={<ArrowBack />} onClick={() => navigate('/decks')} sx={{ color: 'rgba(255,255,255,0.95)' }}>
            Back to Decks
          </Button>
        </Box>
      </GlassBackground>
      ...
      <Box display="flex" justifyContent="space-between" alignItems="flex-start" mb={4}>
        <Box>
          <Button 
            ...
            sx={{ mb: 2, color: 'rgba(255,255,255,0.95)' }}
          >
            Back to Decks
          </Button>
          <Typography variant="h4" component="h1" gutterBottom sx={{ color: 'rgba(255,255,255,0.95)' }}>
            📚 {deck.title}
          </Typography>
