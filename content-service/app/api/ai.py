...
async def generate_flashcards_with_ai(
    ...
    try:
        ...
        deck_create = DeckCreate(
            ...
            course_id=None,  # Deck AI có thể không thuộc course cụ thể
            lesson_id=None
        )
        
        created_deck = await deck_crud.create(deck_create)
        ...
        for i, flashcard_data in enumerate(flashcards_data):
            ...
            flashcard = await flashcard_crud.create(flashcard_create)
